 ...
 */
	...
	//ALTER TABLE `yzj_links` ADD `isbold` TINYINT(1) NOT NULL DEFAULT '0' COMMENT '是否加粗' AFTER `title`, ADD `colors` VARCHAR(6) NULL DEFAULT NULL COMMENT '颜色值' AFTER `isbold`;
        public $info = array(
            'name'=>'Links',
            'title'=>'友情连接',
            'description'=>'友情连接插件',
