...
class ReportController extends AdminController {
    ...
    public function detail() {
        ...
        if ($day) { /*         * *按天数统计 */
             ...
             * 当天退货金额、种类、数量计算
             */
            $data = M("order_refund")->where(" refund_type= 2")->select();
             ...
             * 当天退款金额、种类、数量计算
             */
            $data = M("order_refund")->where(" refund_type= 1")->select();
        ...
        if ($week) { /*         * *按周数统计 */
             ...
             * 本周申请取消订单金额、种类、数量计算
             */
//            $cdata = M("order")->where("status='-2' and refund_status= 0")->select();
//            foreach ($cdata as $k => $val) {
//                /* 格式时间戳为 20141024 */
//                $setime = $val['cancel_time'];
//                $se = date('W', $setime);
//                if ($w == $se) {
//                    //当天
//                    /* 取消订单的商品总额 */
