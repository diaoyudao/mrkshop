    ...
    <div class="cf">
        ...
        <div class="search-form fr cf">
            <div class="sleft">
                ...
                <a class="sch-btn" href="javascript:;" id="search" url="/Admin/Promotionxianshi/"><i class="btn-search"></i></a>
            </div>
        </div>
    </div>
    ...
    <div class="data-table table-striped">
        <table>
            ...
            <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$order): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><?php echo ($order["xianshi_id"]); ?></td>
                        <td><a title="xianshi_name" href="<?php echo U('add?xianshi_id='.$order['xianshi_id']);?>"><?php echo ($order["xianshi_name"]); ?></a></td>
                        <td><?php echo ($order["xianshi_title"]); ?></td>
                        <td><?php echo ($order["xianshi_explain"]); ?></td>
                        <td><img alt="<?php echo ($order["xianshi_name"]); ?>" style="height: 30px;width: auto;"  src="/Uploads/Picture//1/<?php echo (get_cover($order["banner"],'path')); ?>"></td>
                        <td><?php echo ($order["discount"]); ?></td>
                        <td><?php echo (date('Y-m-d H:i:s',$order["start_time"])); ?>--<?php echo (date('Y-m-d H:i:s',$order["end_time"])); ?></td>
                        <td><?php echo ($order["status_text"]); ?></td>
                        <td>
                            <a title="折扣商品" href="<?php echo U('promotionxianshi/add_goods?xianshi_id='.$order['xianshi_id']);?>">折扣商品</a>
                            <a title="编辑" href="<?php echo U('add?xianshi_id='.$order['xianshi_id']);?>">编辑</a>
                            <a class="confirm ajax-get" title="删除" href="<?php echo U('del?status=-1&ids='.$order['xianshi_id']);?>">删除</a>
                        </td>
