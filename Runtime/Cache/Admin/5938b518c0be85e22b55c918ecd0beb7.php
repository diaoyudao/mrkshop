...
<body>
    ...
    <div class="towp hot-sale clear">
        <div class="hot-sale1  fl">
            ...
            <div class="hot2">
                 <?php echo hook('Advs',array('mark'=>'hot_A2','domainid'=>'','domaintype'=>'site'));?>
            </div>
        ...
        <div class="form-item cf" style='margin-top:20px;'>
            ...
            <a class="btn btn-next" href="<?php echo U('AdvertisingPage/imgdetail',array('domainid'=>1,'id'=>14));?>">编辑热卖</a>
...
//            })
    ...
    <script>
            //导航高亮
        highlight_subnav('<?php echo U("Websetting/hot");?>');
    </script>
