...
<body>
	...
	<div class="cf">
		<div class="fl">
			<div class="btn-group"> 
			    <button class="btn document_add" url="<?php echo U('goods/add',array('cate_id'=>$cate_id,'pid'=>I('pid',0),'model_id'=>5));?>" >新 增</button>
			</div>
		...
		<table>
            ...
            <tbody>
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><?php if($data["product_type"] == 1): ?><span style="background: #005ea8;color:#fff; border-radius: 2px; padding:2px;" >普通商品</span><?php endif; ?>
                            <?php if($data["product_type"] == 3): ?><span style="background: #149bdf;color:#fff; border-radius: 2px; padding:2px;">直邮商品</span>
                            <?php elseif($data["product_type"] == 2 ): ?>
                            <span style="background: green;color:#fff; border-radius: 2px; padding:2px;">跨境商品</span><?php endif; ?>
                        </td>
			...
			<td><a target="_blank" title="浏览" href="index.php?s=Goods/detail/id/<?php echo ($data['id']); ?>.html">浏览</a></td>
