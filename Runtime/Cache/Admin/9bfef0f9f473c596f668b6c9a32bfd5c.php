...
<body>
	...
	<div class="main-title"> 
		<h2>
		分类管理 [  
		<?php if(($ismenu) != "2"): ?><a href="<?php echo U('index',array('ismenu'=>2));?>">商品分类</a><?php else: ?>商品分类<?php endif; ?>&nbsp;
		<?php if(($ismenu) != "1"): ?><a href="<?php echo U('index',array('ismenu'=>1));?>">品牌分类</a><?php else: ?>品牌分类<?php endif; ?>&nbsp;
		<?php if(($ismenu) != "3"): ?><a href="<?php echo U('index',array('ismenu'=>3));?>">文章分类</a><?php else: ?>文章分类<?php endif; ?>&nbsp;
		<!--<?php if(($ismenu) != "4"): ?><a href="<?php echo U('index',array('ismenu'=>4));?>">百科分类</a><?php else: ?>百科分类<?php endif; ?>&nbsp;-->
		<!--<?php if(($ismenu) != "5"): ?><a href="<?php echo U('index',array('ismenu'=>5));?>">问答分类</a><?php else: ?>问答分类<?php endif; ?>&nbsp;-->
		<!--<?php if(($ismenu) != "6"): ?><a href="<?php echo U('index',array('ismenu'=>6));?>">专题分类</a><?php else: ?>专题分类<?php endif; ?>&nbsp;--> 
		] 
		</h2> 
	</div>
	...
	<div class="tb-unit posr">
		<div class="tb-unit-bar">
			<a class="btn" href="<?php echo U('add',array('ismenu'=>$ismenu));?>">新 增</a>
		</div>
		<div class="category">
			<div class="hd cf">
