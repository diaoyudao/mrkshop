...
<body>
	...
	<div class="main-title">
		<h2><?php echo isset($info['id'])?'编辑':'新增';?>网址导航</h2>
	</div>
	<div class="tab-wrap">
		...
		<div class="tab-content">
			...
			<div id="tab1" class="tab-pane in tab1"> 
			    <div class="form-item"> 
				<div class="form-item">
				    <label class="item-label">上级<span class="check-tips"></span></label>
				    <div class="controls">
					    <input type="text" class="text input-large" disabled="disabled" value="<?php echo ((isset($category['name']) && ($category['name'] !== ""))?($category['name']):'无'); ?>"/>
				    </div>
				</div>
				<div class="form-item">
				    <label class="item-label">
					    链接名称<span class="check-tips">（名称不能为空）</span>
				    </label>
				    <div class="controls">
				...
				<div class="form-item">
				    <label class="item-label">
					    链接地址<span class="check-tips">（请输入以http://开头的url地址）</span>
				    </label>
				    <div class="controls">
	...
	<script type="text/javascript"> 
		//导航高亮
		highlight_subnav('<?php echo U('Sitemap/index');?>'); 
	</script>
