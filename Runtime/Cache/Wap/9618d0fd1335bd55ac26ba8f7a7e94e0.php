...
<!-- 主体 -->
	...
	<div class="login-4">
		...
		<div class="main">
			<form action="<?php echo U('member/changepassword');?>" method="post" class="validate" onsubmit="validateCallback(this, dialogAjaxDone);
                return false;">
				<div class="main">
					<ul>
						<li class="clear"><label for="">旧密码</label><input type="password" name="old" id="old"
						                                                  placeholder="请输入旧密码"/></li>
						<li class="clear"><label for="">新密码:</label><input type="password" name="password" id="password"
						                                                   placeholder="请输入新密码"/></li>
						<li class="clear"><label for="">确认新密码</label><input type="password" name="repassword"
						                                                    id="repassword" placeholder="请再次输入新密码"/>
						</li>
