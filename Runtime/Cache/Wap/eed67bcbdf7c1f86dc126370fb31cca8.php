...
<!-- 主体 -->
    ...
    <div class="login-1">
        <div class="herder">
            ...
            <h3>注册1/2</h3>
            <a class="login" href="<?php echo U('Member/login');?>">登录</a>
        </div>
        <div class="main">
            <form action="<?php echo U('Member/register');?>" method="post" class="validate" onsubmit="validateCallback(this, dialogAjaxDone); return false;">
                <ul>
                    ...
                    <?php $code = $_GET['code']; if(empty($code)): ?>
                    <li class="clear"><label for="">介绍邀请码</label><input type="tel" name="agent_code" value="<?php echo I('code');?>" id="agent_code" placeholder="请输入密码(选填)" /></li>
                    <?php endif; ?>
                    <li>
