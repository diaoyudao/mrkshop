                    ...
                    <div class="head-pro ">
                        <a href="#">
                            ...
                            <?php if(!empty($impath)): ?><img src="/Uploads/Face/<?php echo ($commentinfo["uid"]); ?>/face.jpg?r=<?php echo ($random); ?>" alt="<?php echo (get_username($commentinfo['uid'])); ?>">
                                <?php else: ?>
                                <img src="/Public/Web/img/head.jpg" alt=""><?php endif; ?>
...
<!--                                <li><img src="/Public/Web/img/pro-Detail/show-pro.jpg" alt=""></li>
                                <li><img src="/Public/Web/img/pro-Detail/show-pro.jpg" alt=""></li>
                                <li><img src="/Public/Web/img/pro-Detail/show-pro.jpg" alt=""></li>-->
                            </ul>
                            <div class="img_zomm">
                            ...
                            <div class="ping ">
                                <div class="pingfen pingfen<?php echo ($commentinfo["score"]); ?>"><img src="/Public/Web/img/commstar.jpg" /> </div>
                                <div class="colo9">
