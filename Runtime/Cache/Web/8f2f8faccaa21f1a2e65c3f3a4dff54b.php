            ...
            <div class="content right-con2 order-mana">
                <div class="con-tit"><h2 class="">订单管理</h2>
                    <div class="sear  fr search-form">
                        <i class="bg" id="search" url="<?php echo U('Order/index');?>" style="cursor:pointer;"></i>
                        <input type="text" class="bor3" name='ordersn' value="<?php echo I('ordersn');?>" placeholder="商品编号/订单号">
                ...
                <div class="order-table">
                    <div class="order-tit order-tit2">
                        <span <?php if(($state_type) == "all"): ?>class="active9"<?php endif; ?> ><a href="<?php echo U('order/index');?>">全部订单<span class="colo6">（<?php echo ($ordernum["ordersum"]); ?>）</span></a></span>
                        <span <?php if(($state_type) == "state_new"): ?>class="active9"<?php endif; ?> ><a href="<?php echo U('order/index',array('state_type'=>'state_new'));?>">待付款<span class="colo6">（<?php echo ($ordernum["nopaynum"]); ?>）</span></a></span>
                        <span <?php if(($state_type) == "state_pay"): ?>class="active9"<?php endif; ?> ><a href="<?php echo U('order/index',array('state_type'=>'state_pay'));?>">待发货<span class="colo6">（<?php echo ($ordernum["paynum"]); ?>）</span></a></span>
                        <span <?php if(($state_type) == "state_send"): ?>class="active9"<?php endif; ?> ><a href="<?php echo U('order/index',array('state_type'=>'state_send'));?>">待收货<span class="colo6">（<?php echo ($ordernum["shipnum"]); ?>）</span></a></span>
                        <span <?php if(($state_type) == "state_noeval"): ?>class="active9"<?php endif; ?> ><a href="<?php echo U('order/index',array('state_type'=>'state_noeval'));?>">待评价<span class="colo6">（<?php echo ($ordernum["noevalnum"]); ?>）</span></a></span>
                        <span <?php if(($state_type) == "state_eval"): ?>class="active9"<?php endif; ?> ><a href="<?php echo U('order/index',array('state_type'=>'state_eval'));?>">已评价<span class="colo6">（<?php echo ($ordernum["evalnum"]); ?>）</span></a></span>
                        <span <?php if(($state_type) == "state_cancel"): ?>class="active9"<?php endif; ?> ><a href="<?php echo U('order/index',array('state_type'=>'state_cancel'));?>">已取消<span class="colo6">（<?php echo ($ordernum["cancelordernum"]); ?>）</span></a></span>
                        <span <?php if(($state_type) == "state_success"): ?>class="active9"<?php endif; ?> ><a href="<?php echo U('order/index',array('state_type'=>'state_success'));?>">已完成<span class="colo6">（<?php echo ($ordernum["completenum"]); ?>）</span></a></span>
                        <div class="tables">
                            <table width="100%">
                                <colgroup span="8">
                                    <col width="33%" />
                    ...
                    <?php if(!empty($orderlist)): if(is_array($orderlist)): $i = 0; $__LIST__ = $orderlist;if( count($__LIST__)==0 ) : echo "没有订单" ;else: foreach($__LIST__ as $key=>$order): $mod = ($i % 2 );++$i;?><div class="tables_1">
                                <table width="100%">
                                    <tr>
                                        <td>
                                    ...
                                    <?php if(is_array($order["goodslist"])): $k = 0; $__LIST__ = $order["goodslist"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$goods): $mod = ($k % 2 );++$k; if($k == 1): ?><tr>
                                                <td class="clear">
                                                    ...
                                                    <div class="xinx">
                                                        ...
                                                        <?php if($order["status"] == 3 ): ?><!--and $order.refund_status eq 0 and $goods.iscomment eq 0--->
                                            ...
                                            <tr>
                                                <td class="clear">
                                                    ...
                                                    <div class="xinx">
                                                        <p><a target="_blank" href="<?php echo U('Goods/detail',array('channelname'=>$goods['channelname'],'id'=>$goods['goodid'] ));?>"><?php echo (get_good_name($goods["goodid"])); ?></a></p>
                                                        <?php if(!empty($goods["parameters"])): ?><em>规格：<?php echo ((isset($goods["parameters"]) && ($goods["parameters"] !== ""))?($goods["parameters"]):"无"); ?></em><?php endif; ?>
                                                        <?php if($order["status"] == 3): ?><!-- and $goods.iscomment eq 0   and $order.refund_status eq 0--->
                                                            <?php $completetime =$order['complete_time'] ; $refundtime =(C("ORDER_AUTO_REFUND") ? : 1 ) * 24*60*60; if($completetime+$refundtime > time()){ ?>
                                                            <?php if($goods["refund_id"] > 0): ?><a class='sc' href="<?php echo U('Refund/detail',array('id'=>$goods['refund_id']));?>">查看售后</a>
                                                            <?php else: ?>
                                                            <a class='sc' href="<?php echo U('Refund/apply_refund',array('orderid'=>$order['id'],'goods_id'=>$goods['goodid'],'id'=>$goods['id']));?>">申请售后</a><?php endif; ?>
