...
//         $this->config['notify_url'] = U("Web/Payment/nfy", array('apitype' => $apitype, 'method' => 'notify'), false, true);
//         $this->config['return_url'] = U("Web/Payment/nfy", array('apitype' => $apitype, 'method' => 'return'), false, true);
...
//         $config = array_merge($this->config, $config);
    ...
    public function buildRequestForm(Pay\PayVo $vo) {
        ...
        $map['out_trade_no']= $vo->getOrderNo();
        $check = M("Pay")->where( $map )->save($data);
