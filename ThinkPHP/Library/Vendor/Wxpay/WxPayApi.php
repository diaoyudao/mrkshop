...
class WxPayApi
{
	...
	public static function unifiedOrder($inputObj, $timeOut = 6)
	{
		...
		if( isset($_SESSION["WEB_APP_WXPAY"]) && $_SESSION["WEB_APP_WXPAY"]==1){
			$inputObj->SetAppid(WxPayConfig::WEB_APPID);//公众账号ID
			$inputObj->SetMch_id(WxPayConfig::WEB_MCHID);//商户号
		}else{
	...
	public static function orderQuery($inputObj, $timeOut = 6)
	{
		...
		//by wangcheng
		if( isset($_SESSION['WEB_APP_WXPAY']) && $_SESSION['WEB_APP_WXPAY']==1){
			$inputObj->SetAppid(WxPayConfig::WEB_APPID);//app应用ID
			$inputObj->SetMch_id(WxPayConfig::WEB_MCHID);//app商户号
		}else{
			$inputObj->SetAppid(WxPayConfig::APPID);//公众账号ID
			$inputObj->SetMch_id(WxPayConfig::MCHID);//商户号
		}
